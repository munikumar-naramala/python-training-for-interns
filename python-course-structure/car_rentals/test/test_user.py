...
def test_login_success():
    response = client.post("/user/login", data={"username": "sanjana", "password": "sanjana"})
...
auth_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJzYW5qYW5hIiwiZXhwIjoxNjkwNTE1MjMzfQ.3rFosHERaO6_cYpjbDj-ym5cT-VnS4X07_KDPkVr6lw"
